...
<!-- Mirrored from connectme-html.themeyn.com/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Nov 2024 06:23:50 GMT -->
                                    ...
                                    <div class="row g-3 gx-4">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="username" placeholder="yourname" name="name" required>
                                                    @error('name')
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="email" class="form-control" id="email-address" placeholder="youremail@example.com" name="email" required>
                                                    @error('email')
                                                    <span class="text-danger">{{$message}}</span>
                                                 @enderror
                                                </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="password" name="confirm-password" class="form-control" id="repeat-password" placeholder="password again" required>
