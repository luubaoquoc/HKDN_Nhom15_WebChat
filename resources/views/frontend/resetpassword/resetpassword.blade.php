                            ...
                            <div class="p-4">
                                <h3>Reset Password</h3>
                                    <div class="row g-3">
                                        {{-- <div class="col-12">
                                          <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                 <input type="text" name="email" class="form-control" id="email-address" placeholder="youremail@example.com" required>
                                                 @error('email')
                                        ...
                                        <div class="col-12">
                                           <div class="form-group">
                                               <label class="form-label d-flex" for="password">Mật khẩu mới</label>
                                                <div class="form-control-wrap">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="form-label d-flex" for="password_confirmation">Xác nhận mật khẩu</label>
                                                 <div class="form-control-wrap">
